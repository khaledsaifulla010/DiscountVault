...
const TopBrands = () => {
  return (
    <div className="mt-20 mb-12">
      <h1 className="lg:text-6xl md:text-5xl lg:ml-0 md:ml-0 ml-12 text-5xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-purple-600">
        Our Top Brands
      </h1>
